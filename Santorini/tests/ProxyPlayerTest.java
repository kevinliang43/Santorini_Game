...
//tests that the proxy player behaves just like it's super class
public class ProxyPlayerTest {
    ...
    public ProxyPlayerTest() {

    }

    public void init() {
        //player that uses strat1 (diagonal)
        this.p1 = new ProxyPlayer("one", 0, new StayAliveStrategy(true, 2));
        //player that uses strat2 (furthest)
        this.p2 = new ProxyPlayer("two", 0, new StayAliveStrategy(false, 2));
    ...
    //tests that we can add a worker
    @Test
